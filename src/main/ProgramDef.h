...
PROGRAM_VERSION[]      = L"3.5.10",
PROGRAM_LANGVER_MIN[]  = L"3.5.10",
PROGRAM_AUTHOR[]       = L"Christian Th\xF6ing",
PROGRAM_AUTHOR_EMAIL[] = L"c.thoeing@web.de",
PROGRAM_COPYRIGHT[]    = L"Copyright \xa9 2002-2025",
...
PROGRAM_URL_VERSION[]  = L"https://pwgen-win.sourceforge.io/version.txt",
PROGRAM_HELPFILE[]     = L"manual.pdf",
PROGRAM_LICENSEFILE[]  = L"license.txt",
PROGRAM_INIFILE[]      = L"PwTech.ini",
PROGRAM_RANDSEEDFILE[] = L"randseed.dat";

const int
PROGRAM_MAINVER_UPDATE_NUM = 20;

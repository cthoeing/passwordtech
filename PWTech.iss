...
Source: "C:\Projekte\PWGen3\manual.pdf"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Projekte\PWGen3\scripting.pdf"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Projekte\PWGen3\German.lng"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "https://sourceforge.net/donate/index.php?group_id=57385"; Description: "{cm:Donate}"; Flags: postinstall shellexec skipifsilent unchecked
